...
| ------ | ------ | ------ | ------ |
| How to customize the User Portal in WSO2 Identity Server 5.10.0 | This post explains the process of customizing the WSO2 Identity Server 5.10.0 **User Portal**. | [Resources](./technical/how-to-customize-the-user-portal-in-wso2-identity-server-5.10.0) | Link |

### How to customize the User Portal in WSO2 Identity Server 5.10.0

This post explains the process of customizing the WSO2 Identity Server 5.10.0 **User Portal**.
